        ...
        <c:forEach var="list" items="${guestlist}">
          <tr>
            ...
            <td class="left_box" align="left">
              <c:if test="${list.guest_step !=0 }">
              <%--답변글일때만 실행 --%>
                <c:forEach begin="1" end="${list.guest_step}" step="1">
              ...
              <a href="guest_cont.do?guest_no=${list.no}&page=${page}&state=cont"
              >${list.guest_title}</a>
            ...
            <td align="center">${list.guest_name}</td>
	  		<td align="center">${list.guest_date}</td>	
	  		<td align="center">${list.guest_hit}</td>
          </tr>
        </c:forEach>
      </c:if>
